...
/***/ function(module, exports, __webpack_require__) {
	...
	var SpawnLocation = __webpack_require__(8);
	...
	Game.prototype.updatePlayerMouse = function (){
	  if (this.playerMouse.pos[0] < 15){
	    this.playerMouse.pos[0] = 15;
	  }else if(this.playerMouse.pos[0] > 785){
	    this.playerMouse.pos[0] = 785;
	  }
	  if (this.playerMouse.pos[1] < 15){
	    this.playerMouse.pos[1] = 15;
	  }else if(this.playerMouse.pos[1] > 585){
	    this.playerMouse.pos[1] = 585;
	  }
	};
