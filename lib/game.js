...
//Game Variables
var BombSpawnxPos = 50;
var BombSpawnyPos = 550;
...
Game.prototype.addBombs = function(num, radius) {
  ...
  for (var i = 0; i < num; i++){
    ...
    bombs.push(new Bomb(
      {
        pos: [BombSpawnxPos, BombSpawnyPos],
        game: this,
        radius: radius
      }
    ));
...
Game.prototype.allObjects = function () {
  return this.bombs.concat(this.playerMouse);
};
...
var SPAWN_LOCATION_COLOR = 'rgb(200, 400, 0)';
var SpawnLocationLeftCord
...
Game.prototype.draw = function (ctx) {
  ...
  ctx.fillRect(0, (this.DIM_Y - 100), 100, 100);
