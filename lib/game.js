...
// Spawn Location constants/variables for easy access
// var SPAWN_LOCATION_COLOR = 'rgb(200, 0, 0)';

Game.prototype.draw = function (ctx) {
  // var SpawnLocationTopLeftCord = this.DIM_Y - 100;
  // var SpawnLocationBottomLeftCord = 0;
  // var SpawnLocationTopRightCord = 100;
  // var SpawnLocationBottomRightCord = 100;
  ...
  // ctx.fillStyle = SPAWN_LOCATION_COLOR;
  // ctx.fillRect(
  //   SpawnLocationBottomLeftCord,
  //   SpawnLocationTopLeftCord,
  //   SpawnLocationTopRightCord,
  //   SpawnLocationBottomRightCord
  // );
